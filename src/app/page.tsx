  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundImage: GRID_BG, backgroundSize: GRID_SIZE }}
      />

      {/* Cursor-lit grid (desktop pointer only) */}
      <div
      ...
      {/* Atmosphere — scaled down on mobile so it doesn't dominate a small screen */}
